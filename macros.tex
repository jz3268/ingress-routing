...
\newcommand\noexport{\texttt{No Export}\xspace}
\newcommand\prepend{\texttt{prepend}\xspace}
\newcommand\nat{\texttt{not\_announce\_to}\xspace}
\newcommand\setlocalpref{\texttt{set\_local\_pref}\xspace}

\newcommand\location{\texttt{location}\xspace}
\newcommand\specificas{\texttt{specific\_AS}\xspace}
\newcommand\aspara{\texttt{ASN\_parameter}\xspace}
\newcommand\asrel{\texttt{AS\_relationship}\xspace}


\newcommand\localpref{\texttt{local\_pref}\xspace}
...
\newcommand\bgpm{BGP announcement\xspace}
\newcommand\bgpmp{BGP announcements\xspace}
\newcommand\anyopt{\texttt{AnyOpt}\xspace}
\newcommand\painter{\texttt{PAINTER}\xspace}
\newcommand\sprite{\texttt{Sprite}\xspace}
\newcommand\tango{\texttt{Tango}\xspace}
\newcommand\pecan{\texttt{PECAN}\xspace}
\newcommand\anycast{\texttt{Anycast}\xspace}

\newcommand\client{{network}\xspace}
\newcommand\clients{{networks}\xspace}
